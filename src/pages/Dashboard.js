...
const Dashboard = () => {
    ...
    const dailyPassengers = 2090; // Nombre de passagers par jour
    const dailyRevenue = (ticketPrice * dailyPassengers).toLocaleString('fr-FR'); // Calcul du revenu total et formatage
                ...
                <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-3xl font-bold text-gray-800">{mockData.buses.filter(b => b.status === 'En Ligne').length} / {mockData.buses.length}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow">
                     <div className="flex items-start">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-sm text-gray-400 mt-1">{dailyPassengers.toLocaleString('fr-FR')} passagers × {ticketPrice} MAD</p>
                        </div>
                    </div>
                </div>
            </div>
